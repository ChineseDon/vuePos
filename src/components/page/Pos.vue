              ...
              <el-table :data="tableData" width="100%" border>
                ...
                <el-table-column label="操作" width="100" fixed="right">
                  <template slot-scope="props">
                    <el-button type="text" size="small" @click="delSingleGoods(props.row)">删除</el-button>
                    <el-button type="text" size="small" @click="addOrderList(props.row)">增加</el-button>
                  </template>
                </el-table-column>
              </el-table>
              <div class="totalDiv">
                <small>数量：</small> <span v-text="totalCount"></span>&nbsp;&nbsp;&nbsp;<small>金额：</small><span v-text="totalMoney + '元'"></span>
              </div>
              <div class="div-btn">
              ...
              <el-tab-pane label="汉堡">
                <ul class="cookList">
                  <li v-for="goods in type0Goods" :key="goods.goodsId" @click="addOrderList(goods)">
                    ...
                    <span class="foodPrice" v-text="'￥'+goods.price+'元'"></span>
                  </li>
                </ul>
              </el-tab-pane>
